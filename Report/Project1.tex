...
\Figure{../Figures/UnitDisk.png}{Orbit of z under $\phi=z^2$}{unitDisk}

By adding a constant to the function (i.e. $\phi(z) = z^2 + c$) the map of the orbit becomes more complex shapes, which turn out to be fractals. 
